...
/// <summary>
/// 提供 TMDb 国家英文名到“中文 (代码)”格式的映射。
/// 例如："Japan" -> "日本 (JP)"
/// 数据基于 TMDb production_countries().name 字段。
/// </summary>
public static class CountryMapper
{
    private static readonly Dictionary<string, string> _countryMap = new Dictionary<string, string>
    {
        ...
        { "Bhutan", "不丹 (BT)" },
        { "Bolivia", "玻利维亚 (BO)" },
        { "Bonaire, Sint Eustatius and Saba", "博奈尔、圣尤斯特歇斯和萨巴 (BQ)" },
        { "Bosnia and Herzegovina", "波斯尼亚和黑塞哥维那 (BA)" },
        { "Botswana", "博茨瓦纳 (BW)" },
        { "Bouvet Island", "布韦岛 (BV)" },
        { "Brazil", "巴西 (BR)" },
        { "British Indian Ocean Territory", "英属印度洋领地 (IO)" },
        { "Brunei Darussalam", "文莱 (BN)" },
        { "Bulgaria", "保加利亚 (BG)" },
        ...
        { "Comoros", "科摩罗 (KM)" },
        { "Congo", "刚果（布） (CG)" },
        { "Congo, Democratic Republic of the", "刚果（金） (CD)" },
        ...
        { "French Southern Territories", "法属南部领地 (TF)" },
        { "Gabon", "加蓬 (GA)" },
        { "Gambia", "冈比亚 (GM)" },
        { "Georgia", "格鲁吉亚 (GE)" },
        { "Germany", "德国 (DE)" },
        ...
        { "India", "印度 (IN)" },
        { "Indonesia", "印度尼西亚 (ID)" },
        { "Iran, Islamic Republic of", "伊朗 (IR)" },
        { "Iraq", "伊拉克 (IQ)" },
        { "Ireland", "爱尔兰 (IE)" },
        { "Isle of Man", "马恩岛 (IM)" },
        { "Israel", "以色列 (IL)" },
        ...
        { "Kenya", "肯尼亚 (KE)" },
        { "Kiribati", "基里巴斯 (KI)" },
        { "Korea, Democratic People's Republic of", "朝鲜 (KP)" },
        { "Korea, Republic of", "韩国 (KR)" },
        { "Kuwait", "科威特 (KW)" },
        { "Kyrgyzstan", "吉尔吉斯斯坦 (KG)" },
        { "Lao People's Democratic Republic", "老挝 (LA)" },
        { "Latvia", "拉脱维亚 (LV)" },
        { "Lebanon", "黎巴嫩 (LB)" },
        { "Lesotho", "莱索托 (LS)" },
        { "Liberia", "利比里亚 (LR)" },
        ...
        { "Mayotte", "马约特 (YT)" },
        { "Mexico", "墨西哥 (MX)" },
        { "Micronesia, Federated States of", "密克罗尼西亚联邦 (FM)" },
        ...
        { "Saint Helena, Ascension and Tristan da Cunha", "圣赫勒拿、阿森松和特里斯坦-达库尼亚 (SH)" },
        { "Saint Kitts and Nevis", "圣基茨和尼维斯 (KN)" },
        { "Saint Lucia", "圣卢西亚 (LC)" },
        { "Saint Martin (French part)", "圣马丁（法属） (MF)" },
        ...
        { "Singapore", "新加坡 (SG)" },
        { "Sint Maarten (Dutch part)", "圣马丁（荷属） (SX)" },
        { "Slovakia", "斯洛伐克 (SK)" },
        { "Slovenia", "斯洛文尼亚 (SI)" },
        ...
        { "Taiwan", "中国台湾 (TW)" },
        { "Tajikistan", "塔吉克斯坦 (TJ)" },
        { "Tanzania, United Republic of", "坦桑尼亚 (TZ)" },
        { "Thailand", "泰国 (TH)" },
        { "Timor-Leste", "东帝汶 (TL)" },
        { "Togo", "多哥 (TG)" },
        { "Tokelau", "托克劳 (TK)" },
        ...
        { "Vanuatu", "瓦努阿图 (VU)" },
        { "Venezuela, Bolivarian Republic of", "委内瑞拉 (VE)" },
        { "Viet Nam", "越南 (VN)" },
    ...
    /// <summary>
    /// 根据 TMDb 返回的英文国家名，获取本地化标签（格式：中文 (代码)）。
    /// 如果未找到映射，则返回原始英文名。
    /// </summary>
    public static string GetLocalizedCountry(string originalCountry)
    {
        ...
        return _countryMap.TryGetValue(originalCountry, out var localized)
            ? localized
            : originalCountry;
    }
}